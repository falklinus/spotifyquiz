        ...
        return (
            <Fragment>
                <div>
                    ...
                    <Button variant="contained" color="primary" onClick={() => this.onPrevClick()}>Previous</Button>
                    <Button variant="contained" color="primary" onClick={() => this.onPlayClick()}>{playing ? "Pause" : "Play"}</Button>
                    <Button variant="contained" color="primary" onClick={() => this.onNextClick()}>Next</Button>
                </div>
