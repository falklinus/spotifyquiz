...
class game extends Component {
    ...
    cleanString = (inputString) => {
        return inputString.toLowerCase().replace(/ /g, "").replace(",","")
            .split('-')[0].split('(')[0];
    };
        ...
        return(
            <div>
                <Container component="main" maxWidth="md">
                    ...
                    <Card className={classes.card} style={{backgroundColor:this.state.answerColor}} >
                        ...
                        {!this.state.gamePaused ? (
                                <div>
                                    ...
                                    <form  noValidate autoComplete="off" className={classes.form}>
                                        <TextField className={classes.textField} fullWidth name="artistName" label="Main Artist Name"
                                        ...
                                        />
                                        <Button onClick={this.onSubmit} className={classes.submitButton} variant="contained" color="primary" fullWidth>
                                            Submit!
                                        </Button>
                                    </form>
                                </div>)
                            : (<div>
                                ...
                                <Button onClick={this.onNextSong} className={classes.submitButton} variant="contained" color="primary" fullWidth>
                                    Next Song!
                                </Button>
                            </div>)
                        }
